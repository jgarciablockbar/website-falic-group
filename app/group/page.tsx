    ...
    <>
      <HeroB bg="/homepage/group.webp">
        ...
        <p className="w-4/5 text-center md:w-1/2 lg:w-1/3 mb-12">
          Renowned for its unrivaled global expertise and commitment to
          excellence, The Falic Group founded in 2001 is a family run group and
          operates 50 prestigious enterprises across 9 houses; retailing, wine &
          spirits, fragrance & cosmetics, fashion & interiors, real estate &
          hospitality, media, distribution, tobacco & other activities. With
          over 6,000 employees spanning 21 countries, their global eco-system
          encompasses 250+ retail and e-Commerce stores.
        </p>
      ...
      <section className="p-10 md:p-20 flex flex-col gap-y-4 items-center">
        <h2 className="text-center text-primary mb-4 font-semibold">
          3 Values of The Falic Group
        </h2>
        {values.map((value) => (
          <CardC key={value.title} {...value} />
        ))}
      </section>
      <section className="bg-secondary p-10 md:p-20 flex flex-col gap-y-12 text-center items-center">
        ...
        <p className="w-4/5 text-center md:w-1/2 text-xl">
          &ldquo;As a group, we are committed to forging the best producer
          partnerships and delivering results at scale. Our experience founding
          Duty Free Americas has taught us a lot about fast growth and
          innovation, and we are committed to delivering the best deals and
          exposure for our partners. One of the great privileges we have is to
          be able to give back to causes close to our heart, and with the Falic
          Family Foundation we support a number of charitable organisations in
          the United States and interntionally.&rdquo;
        </p>
        <p className="uppercase text-gray-600 text-xs">
          <b>Leon Falic</b>, Falic Group President
        </p>
      </section>
    </>
  );
